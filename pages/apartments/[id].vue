            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <Swiper :navigation="true" :modules="[SwiperNavigation, SwiperThumbs, SwiperFreeMode, SwiperZoom]"
                        ...
                        <SwiperSlide>
                            <div class="swiper-zoom-container">
                                <NuxtImg src="/images/apartment_1.jpg" alt="Квартира" class="img-fluid rounded"
                                    sizes="md:600px" />
                            </div>
                        ...
                        <SwiperSlide>
                            <div class="swiper-zoom-container">
                                <NuxtImg src="/images/apartment_2.jpg" alt="Квартира" class="img-fluid rounded"
                                    sizes="md:600px" />
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div class="swiper-zoom-container">
                                <NuxtImg src="/images/apartment_3.jpg" alt="Квартира" class="img-fluid rounded"
                                    sizes="md:600px" />
                            </div>
                        </SwiperSlide>
                    </Swiper>
                    <Swiper @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="4" :freeMode="true"
                        ...
                        <SwiperSlide>
                            <NuxtImg src="/images/apartment_2.jpg" alt="Квартира"
                                class="img-slider-thumb img-fluid w-100 rounded" sizes="md:300px" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <NuxtImg src="/images/apartment_3.jpg" alt="Квартира"
                                class="img-slider-thumb img-fluid w-100 rounded" sizes="md:300px" />
                        </SwiperSlide>
                    </Swiper>
                    <hr>
                    ...
                    <div>
                        <YandexMap v-model="map" :settings="settings"
                        height="320px">
